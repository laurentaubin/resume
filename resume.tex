...
\begin{resume}
    ...
    \NewEntry{\textsl{Baccalaur\'{e}at en g\'{e}nie logiciel (B. Ing.).} \hfill \textbf{Depuis septembre 2018}}
    \begin{itemize}[nosep]
    ...
    \NewEntry{\textsl{Pr\'{e}pos\'{e} \`{a} l'arri\`{e}re boutique} \hfill \textbf{Juin 2013 -- Aout 2018}}
    \begin{itemize}[nosep]
